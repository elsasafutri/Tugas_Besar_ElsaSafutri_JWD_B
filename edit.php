...
<body>
    <main class="container my-5">
        <center><h2 class="text-black">BUKU</h2></center>
        <div class="card">
            <div class="card-body">
                <?php
                include 'konek.php';
                ...
                ?>
                    <form action="update.php" method="POST" class="row g-3 needs-validation" novalidate>
                        ...
                        <div class="col-md-12">
                            ...
                            <input type="text" name="tahun_terbit" class="form-control" id="tahun_terbit" value="<?= $d['tahun_terbit']?>" required>
                            <div class="invalid-feedback">
                        ...
                        <div class="col-md-12">
                            ...
                            <input type="text" name="isbn" class="form-control" id="isbn" value="<?= $d['isbn']?>" required>
                            <div class="invalid-feedback">
                                ISBN wajib di isi!
                            </div>
                        </div>
                        <div class="col-12">
                            <button class="btn btn-primary" type="submit" name="simpan" value="simpan data">Simpan</button>
                        </div>
                    </form>
                <?php
                }
